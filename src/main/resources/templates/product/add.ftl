                ...
                <div class="span12">
                    <form id="productFrom" method="post" action="${basePath}/seller/product/add">
                        <fieldset>
                            <legend>增加商品</legend>
                            <label>商品名称</label><br>
                            <input id="productName" name="productName" type="text" /> <span class="help-block"></span><br>
                            <label>单价  </label><br>
                            <input id="productPrice" name="productPrice" type="text" /> <span class="help-block"></span><br>
                            <label>库存  </label><br>
                            <input id="productStock" name="productStock" type="text" /> <span class="help-block"></span><br>
                            <label>描述  </label><br>
                            <input id="productDescription" name="productDescription" type="text" /> <span class="help-block"></span><br>
                            <label>图片  </label><br>
